...
import com.security.demosdktest.login.IAccountConfirmView;
import com.security.demosdktest.login.activity.AccountConfirmActivity;
...
import static com.security.demosdktest.login.activity.AccountConfirmActivity.MODE_REGISTER;
...
public class AccountConfirmPresenter extends BasePresenter {
    ...
    private IRegisterCallback mIRegisterCallback = new IRegisterCallback() {
        ...
        public void onSuccess(User user) {
            ...
            iTuyaSecurityService.getServiceInfoWithHandler(new ITuyaResultCallback<ServiceDealerBean>() {
                ...
                public void onError(String errorCode, String errorMessage) {
                    Message msg = MessageUtil.getCallFailMessage(MSG_REGISTER_SUCC, errorCode, errorMessage);
                    mHandler.sendMessage(msg);
                }
            });
        }
        ...
        @Override
        public void onError(String errorCode, String errorMsg) {
            Message msg = MessageUtil.getCallFailMessage(MSG_REGISTER_SUCC, errorCode, errorMsg);
            mHandler.sendMessage(msg);
        }
    };
