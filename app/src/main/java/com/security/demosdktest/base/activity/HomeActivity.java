...
import com.security.demosdktest.base.presenter.HomePresenter;
import com.security.demosdktest.base.utils.ActivityUtils;
import com.security.demosdktest.base.view.IHomeView;
import com.security.demosdktest.family.activity.FamilyEmptyActivity;
...
public class HomeActivity extends BaseActivity implements IHomeView {
    ...
    protected TextView mTvMySecurity;
    protected TextView mTvHomeCenter;
    private ImageView mIvMyDevice;
    private ImageView mIvMySecurity;
    ...
    protected void initView() {
        ...
        mTvMySecurity = (TextView) findViewById(R.id.tv_home_my_security);
        mTvMySecurity.setOnClickListener(mClickListener);
        mIvMySecurity = (ImageView) findViewById(R.id.iv_my_security);
        mIvMySecurity.setImageResource(R.drawable.ty_security);
        mIvMySecurity.setOnClickListener(mClickListener);
        mIvMySecurity.setColorFilter(mFuncBarTextNormalColor);
    ...
    protected View.OnClickListener mClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            } else if (v.getId() == R.id.tv_home_my_security || v.getId() == R.id.iv_my_security) {
                mHomePresenter.showMySecurityPage();
            }
        }
    };
    ...
    public void onItem(int id) {
        switch (id) {
            ...
            case HomePresenter.TAB_PERSONAL_CENTER:
                ...
                mFragmentContainer.setCurrentItem(idToPosition(id), true);
                break;
            case HomePresenter.TAB_MY_SECURITY:
                mTvMySecurity.setTextColor(mFuncBarTextSelectColor);
                mIvMySecurity.setColorFilter(mFuncBarTextSelectColor);
                mIvMySecurity.setImageResource(R.drawable.ty_security);
                mFragmentContainer.setCurrentItem(idToPosition(id), true);
                break;
        }
    ...
    public void offItem(int id) {
        switch (id) {
            ...
            case HomePresenter.TAB_PERSONAL_CENTER:
                ...
                break;
            case HomePresenter.TAB_MY_SECURITY:
                mTvMySecurity.setTextColor(mFuncBarTextNormalColor);
                mIvMySecurity.setColorFilter(mFuncBarTextNormalColor);
                mIvMySecurity.setImageResource(R.drawable.ty_security);
                break;
        }
    ...
    protected int postionToId(int pos) {
        switch (pos) {
            ...
            case 3:
                return HomePresenter.TAB_MY_SECURITY;
